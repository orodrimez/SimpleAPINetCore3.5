...
using ExamenYache.Repository;

namespace ExamenYache
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationDBContext>(opt =>    opt.UseInMemoryDatabase("Frutas"));
            ...
            services.AddAutoMapper(typeof(FrutasMapper));
